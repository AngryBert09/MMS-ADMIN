...
$(document).ready(function () {
    ...
    $(document).ready(function () {
        if ($("#invoice_chart").length > 0) {
            ...
            // AJAX request to fetch invoice analytics
            $.ajax({
                url: "/invoice-analytics", // Update endpoint if needed
                type: "GET",
                dataType: "json",
                success: function (data) {
                    ...
                    // Extract the first available analytics entry
                    ...
                    let draft = analytics.draftInvoices || 0;

                    var pieConfig = {
                        colors: ["#7638ff", "#ff737b", "#fda600", "#1ec1b0"],
                        series: [paid, unpaid, overdue, draft],
                        chart: {
                            fontFamily: "Poppins, sans-serif",
                            height: 350,
                            type: "donut",
